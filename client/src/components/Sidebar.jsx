...
const Sidebar = ({ menuOpen, setMenuOpen, setDarkMode, darkMode, setUploadOpen }) => {
  ...
  const menuItems = [
    ...
    {
      link: currentUser ? "/saved" : null,
      name: "Saved",
      icon: <BookmarkRounded />,
      onClick: currentUser ? null : () => dispatch(openSignin())
    },
  ];
  ...
  const buttons = [
    ...
    {
      fun: currentUser ? logoutUser : () => dispatch(openSignin()),
